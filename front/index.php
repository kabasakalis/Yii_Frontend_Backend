...
$configFrontFolder=$realRoot.'frontend'.DS.'config'.DS;
$configFrontFile = YII_DEBUG ? 'dev.php' : 'production.php';

$configFront=require($configFrontFolder.$configFrontFile);
...
//fb($configFront);
 ...
 Yii::createWebApplication($configFront)->run();
